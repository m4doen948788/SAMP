...
async function run() {
  try {
    console.log('🔄 Running migration: 20260731_02_add_quick_access_menu...');
    ...
    if (existing.length === 0) {
      ...
      console.log('  - Created Quick Access menu & assigned permissions for roles 1-11');
    }

    console.log('✅ Migration 20260731_02_add_quick_access_menu completed successfully.');
    process.exit(0);
  } catch (err) {
