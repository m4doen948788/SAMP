...
const downloadFile = async (req, res) => {
    try {
        ...
        const possiblePaths = [
            path.join(__dirname, '../../../../uploads', fileDiskName),
            path.join(process.cwd(), 'uploads', fileDiskName),
            path.join(process.cwd(), 'Backend', 'uploads', fileDiskName),
            path.resolve('/home/ppm/uploads_ppm_storage', fileDiskName)
        ];
