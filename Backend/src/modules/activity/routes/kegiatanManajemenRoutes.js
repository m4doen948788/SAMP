...
router.get('/:id/dokumen/:dokumenId/word-content', verifyToken, controller.getWordContent);
router.put('/:id/dokumen/:dokumenId/word-content', verifyToken, controller.saveWordContent);
router.get('/:id/dokumen/:dokumenId/word-history', verifyToken, controller.getWordHistory);
