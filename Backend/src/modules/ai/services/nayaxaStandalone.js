...
const nayaxaStandalone = {
    ...
    executeSQL: async (query) => {
        ...
        const forbiddenPatterns = [
            /DROP/i, /DELETE/i, /UPDATE/i, /INSERT/i, /ALTER/i, /TRUNCATE/i, /CREATE/i
        ];
        ...
        if (isForbidden || !query.trim().toUpperCase().startsWith('SELECT')) {
            return { success: false, message: "Security Exception: Perintah atau tabel ini dibatasi dan tidak dapat diakses oleh AI." };
        }
