...
`;const xs=({isOpen:s,onClose:a,onRestore:o})=>{const[m,u]=d.useState([]),[x,p]=d.useState(!1),[g,b]=d.useState(null),h=async()=>{p(!0),b(null);try{const y=await N.dokumen.getTrash("surat");y.success?u(y.data):b(y.message)}catch(y){b(y.message)}finally{p(!1)}};d.useEffect(()=>{s&&h()},[s]);const _=async y=>{try{const D=await N.dokumen.restore(y);D.success?(h(),o()):f.error(D.message)}catch(D){f.error(D.message)}},A=async y=>{if(window.confirm("Hapus dokumen ini secara permanen? Aksi ini tidak dapat dibatalkan."))try{const D=await N.dokumen.permanentDelete(y);D.success?(h(),f.success("Dokumen berhasil dihapus permanen")):f.error(D.message)}catch(D){f.error(D.message)}};return s?xt.createPortal(e.jsxs("div",{className:"fixed inset-0 z-[100] flex items-center justify-center p-4",children:[e.jsx("div",{className:"absolute inset-0 bg-slate-900/60 backdrop-blur-sm",onClick:a}),e.jsxs("div",{className:"relative w-full max-w-4xl bg-white rounded-[32px] shadow-2xl overflow-hidden flex flex-col max-h-[90vh]",children:[e.jsxs("div",{className:"p-6 border-b border-slate-100 flex items-center justify-between bg-slate-50/50",children:[e.jsxs("div",{className:"flex items-center gap-4",children:[e.jsx("div",{className:"w-12 h-12 bg-rose-50 text-rose-600 rounded-2xl flex items-center justify-center shadow-sm",children:e.jsx(Z,{size:24})}),e.jsxs("div",{children:[e.jsx("h2",{className:"text-xl font-black text-slate-800 tracking-tight",children:"Tempat Sampah Surat"}),e.jsx("p",{className:"text-slate-500 text-xs font-bold uppercase tracking-widest mt-0.5",children:"Dokumen terhapus (Kategori: Surat)"})]})]}),e.jsx("button",{onClick:a,className:"w-10 h-10 flex items-center justify-center rounded-xl bg-white border border-slate-200 text-slate-400 hover:text-slate-600 hover:border-slate-300 transition-all active:scale-95",children:e.jsx(Oe,{size:20})})]}),e.jsx("div",{className:"flex-1 overflow-y-auto p-6 min-h-0 scrollbar-thin scrollbar-thumb-slate-200 scrollbar-track-transparent",children:x?e.jsxs("div",{className:"flex flex-col items-center justify-center py-20 gap-4",children:[e.jsx(Be,{className:"animate-spin text-rose-500",size:40}),e.jsx("p",{className:"text-sm font-black text-slate-400 uppercase tracking-widest",children:"Memuat Data Sampah..."})]}):g?e.jsxs("div",{className:"flex flex-col items-center justify-center py-20 text-rose-500 bg-rose-50 rounded-3xl border border-rose-100 italic gap-2",children:[e.jsx(Le,{size:32}),e.jsx("p",{className:"font-bold",children:g})]}):m.length===0?e.jsxs("div",{className:"flex flex-col items-center justify-center py-20 text-slate-300 gap-4",children:[e.jsx("div",{className:"w-20 h-20 bg-slate-50 rounded-full flex items-center justify-center border-4 border-white shadow-inner",children:e.jsx(Z,{size:40})}),e.jsx("p",{className:"text-sm font-black uppercase tracking-widest text-slate-400",children:"Tempat sampah kosong"})]}):e.jsx("div",{className:"grid gap-3",children:m.map(y=>e.jsxs("div",{className:"flex items-center gap-4 p-4 bg-slate-50 rounded-[24px] border border-slate-100 hover:bg-white hover:border-indigo-200 transition-all group",children:[e.jsx("div",{className:"w-12 h-12 bg-white rounded-2xl flex items-center justify-center text-slate-400 border border-slate-100 shadow-sm group-hover:text-indigo-500 transition-colors",children:e.jsx(W,{size:20})}),e.jsxs("div",{className:"flex-1 min-w-0",children:[e.jsx("h4",{className:"font-bold text-slate-700 truncate",children:y.nama_file}),e.jsxs("div",{className:"flex items-center gap-3 mt-1",children:[e.jsx("span",{className:"text-[10px] font-black text-indigo-600 bg-indigo-50 px-2 py-0.5 rounded uppercase tracking-tight",children:y.jenis_dokumen_nama}),e.jsxs("span",{className:"text-[10px] font-bold text-slate-400 flex items-center gap-1",children:[e.jsx(pe,{size:10}),"Dihapus: ",new Date(y.deleted_at).toLocaleDateString("id-ID",{day:"numeric",month:"short",year:"numeric"})]})]})]}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("button",{onClick:()=>_(y.id),className:"px-4 py-2 bg-white text-indigo-600 rounded-xl font-bold text-xs border border-indigo-100 hover:bg-indigo-600 hover:text-white transition-all active:scale-95 shadow-sm",children:"Pulihkan"}),e.jsx("button",{onClick:()=>A(y.id),className:"p-2 bg-white text-rose-500 rounded-xl font-bold text-xs border border-rose-100 hover:bg-rose-500 hover:text-white transition-all active:scale-95 shadow-sm",children:e.jsx(Z,{size:16})})]})]},y.id))})})]})]}),document.body):null},us=({isOpen:s,onClose:a,onConfirm:o,file:m,fileName:u,setFileName:x,isSubmitting:p})=>{if(!s||!m)return null;const g=m.name.split(".").pop();return e.jsx("div",{className:"fixed inset-0 z-[1000] flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm animate-in fade-in duration-300",children:e.jsxs("div",{className:"bg-white rounded-[2rem] w-full max-w-md overflow-hidden shadow-2xl border border-white/20 animate-in zoom-in-95 duration-300",children:[e.jsxs("div",{className:"px-6 py-4 border-b border-slate-50 flex items-center justify-between bg-slate-50/50",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("div",{className:"p-2 bg-emerald-50 text-emerald-600 rounded-xl",children:e.jsx(Pe,{size:20})}),e.jsxs("div",{children:[e.jsx("h3",{className:"font-black text-slate-800 tracking-tight",children:"Unggah Dokumen Final"}),e.jsx("p",{className:"text-[10px] text-slate-400 font-bold uppercase tracking-widest mt-1",children:"Konfirmasi nama file sistem"})]})]}),e.jsx("button",{onClick:a,className:"p-2 hover:bg-white rounded-xl text-slate-400 hover:text-rose-500 transition-all",children:e.jsx(Oe,{size:20})})]}),e.jsxs("div",{className:"p-6 space-y-4",children:[e.jsxs("div",{className:"p-4 bg-slate-50 rounded-2xl border border-slate-100 flex items-center gap-4",children:[e.jsx("div",{className:"p-3 bg-white rounded-2xl shadow-sm text-slate-400",children:e.jsx(W,{size:24})}),e.jsxs("div",{className:"min-w-0 flex-1",children:[e.jsx("p",{className:"text-xs font-black text-slate-700 truncate",children:m.name}),e.jsx("p",{className:"text-[10px] font-bold text-slate-400 uppercase tracking-widest",children:"File Terpilih"})]})]}),e.jsxs("div",{className:"space-y-2",children:[e.jsx("label",{className:"text-[10px] font-black text-indigo-600 uppercase tracking-widest ml-1",children:"Nama File di Sistem"}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("input",{type:"text",className:"w-full h-10 px-4 bg-slate-50 border border-slate-200 rounded-xl focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 focus:bg-white transition-all font-black text-slate-700 text-sm",value:u,onChange:b=>x(b.target.value),placeholder:"Masukkan nama file..."}),e.jsxs("div",{className:"h-10 px-3 bg-slate-100 border border-slate-200 rounded-xl flex items-center justify-center text-xs font-bold text-slate-400",children:[".",g]})]}),e.jsx("p",{className:"text-[9px] font-bold text-slate-400 ml-1 italic",children:"* Ekstensi file dikunci demi integritas data"})]})]}),e.jsxs("div",{className:"p-6 bg-slate-50/50 border-t border-slate-50 flex items-center justify-end gap-3",children:[e.jsx("button",{onClick:a,className:"px-4 py-2 rounded-xl font-bold text-xs text-slate-500 hover:bg-white transition-all",children:"Batal"}),e.jsx("button",{onClick:o,disabled:p||!u.trim(),className:"px-6 py-2 rounded-xl bg-emerald-600 text-white font-black text-sm shadow-lg shadow-emerald-600/20 flex items-center gap-2 hover:bg-emerald-700 transition-all active:scale-95 disabled:opacity-50",children:p?e.jsxs(e.Fragment,{children:[e.jsx(Be,{size:14,className:"animate-spin"})," Mengunggah..."]}):e.jsxs(e.Fragment,{children:[e.jsx(Aa,{size:14,strokeWidth:3})," Unggah Sekarang"]})})]})]})})};function js({onNavigate:s}){const{user:a}=ma(),o=(a==null?void 0:a.tipe_user_id)===1,m=(a==null?void 0:a.tipe_user_id)===2||((a==null?void 0:a.tipe_user_nama)||"").toLowerCase().includes("admin instansi");((a==null?void 0:a.jabatan_nama)||"").toLowerCase().includes("sekretaris");const u=((a==null?void 0:a.jabatan_nama)||"").toLowerCase().includes("arsiparis")||((a==null?void 0:a.tipe_user_nama)||"").toLowerCase().includes("arsiparis"),x=o||u,p=window.location.origin,g=(t,r)=>{const l=encodeURIComponent(t);let n=r||"";n.startsWith(window.location.origin)&&(n=n.replace(window.location.origin,"")),n&&!n.startsWith("/")&&!n.startsWith("http")&&(n="/"+n);const i=n?encodeURIComponent(n):"";return`${ce.endsWith("/api")?ce.substring(0,ce.length-4):ce}/api/public/qr/generate?text=${l}${i?`&logo=${i}`:""}&size=300`},b=(t,r)=>t&&t.replace(/https:\/\/api\.qrserver\.com\/v1\/create-qr-code\/\?size=150x150&data=([^"'\s&]+)/g,(l,n)=>{try{const j=decodeURIComponent(n).match(/[?&]v=([^&]+)/);if(j){const c=j[1],$=`${p}${p.endsWith("/")?"":"/"}?v=${c}`;return g($,r)}}catch{}return l}),[h,_]=d.useState("internal"),[A,y]=d.useState("all"),[D,Fe]=d.useState((a==null?void 0:a.bidang_id)||"all"),[O,wt]=d.useState([]),[yt,He]=d.useState(!0),[re,jt]=d.useState(""),[Ge,Ve]=d.useState("list"),[kt,xe]=d.useState(!1),[_t,Nt]=d.useState("masuk"),[$t,St]=d.useState(null),[At,We]=d.useState(!1),[Dt,Ke]=d.useState(!1),[zt,Et]=d.useState(null),[qe,Ye]=d.useState(null),[ue,ge]=d.useState(.7),[Ct,he]=d.useState(!1),[It,Pt]=d.useState(""),[z,Lt]=d.useState({marginTop:20,marginBottom:20,marginLeft:30,marginRight:20,paperSize:"A4",fontSize:12,lineHeight:1.5,textAlign:"justify",fontFamily:"Arial, sans-serif",paragraphSpacingBefore:0,paragraphSpacingAfter:0,firstLineIndent:0}),[G,P]=d.useState(null),[K,Tt]=d.useState(null),fe=d.useRef(null),[T,ee]=d.useState(null),[L,be]=d.useState(null),[Rt,Je]=d.useState({visibility:"hidden"}),[Mt,ve]=d.useState({visibility:"hidden"}),te=d.useRef(null),we=d.useRef(null),R=d.useRef(null);d.useLayoutEffect(()=>{if(T&&te.current){const t=te.current.getBoundingClientRect();let r=T.x,l=T.y-15,n="-50%",i="-100%";r-t.width/2<20?(r=20,n="0%"):r+t.width/2>window.innerWidth-20&&(r=window.innerWidth-t.width-20,n="0%"),l-t.height<20&&(l=T.y+15,i="0%"),Je({left:`${r}px`,top:`${l}px`,transform:`translateX(${n}) translateY(${i})`,visibility:"visible"})}else Je({visibility:"hidden"});if(L&&we.current){const t=we.current.getBoundingClientRect();let r=L.x,l=L.y-15,n="-50%",i="-100%";r-t.width/2<20?(r=20,n="0%"):r+t.width/2>window.innerWidth-20&&(r=window.innerWidth-t.width-20,n="0%"),l-t.height<20&&(l=L.y+15,i="0%"),ve({left:`${r}px`,top:`${l}px`,transform:`translateX(${n}) translateY(${i})`,visibility:"visible",opacity:1})}else ve(L?{visibility:"visible",opacity:0}:{visibility:"hidden",opacity:0})},[T,L]);const Bt=(t,r)=>{R.current&&clearTimeout(R.current),be(null);const l=t.currentTarget.getBoundingClientRect();let n=[];try{n=typeof r.approval_chain=="string"?JSON.parse(r.approval_chain):r.approval_chain}catch{n=[]}!n||n.length===0||ee({x:l.left+l.width/2,y:l.top,chain:n.filter(i=>i&&i.role),subject:r.perihal,bidang_id:r.bidang_id})},Ot=()=>{ye()},Ut=(t,r)=>{R.current&&clearTimeout(R.current),ee(null);const l=t.currentTarget.getBoundingClientRect();let n=r.edit_history||[];n.length===0&&(n=[{aksi:"create",keterangan:"Surat dicatat di sistem",created_at:r.created_at||new Date().toISOString(),user_nama:r.creator_nama||"System",user_bidang:r.singkatan_bidang||"-"}]),be({x:l.left+l.width/2,y:l.top,history:n,subject:r.perihal})},Ft=()=>{ye()},Qe=()=>{R.current&&clearTimeout(R.current)},Ze=()=>{ye()},ye=()=>{R.current&&clearTimeout(R.current),R.current=setTimeout(()=>{ee(null),be(null)},300)},Ht=async(t,r)=>{const l=window.prompt(`Lompati tahap persetujuan untuk ${r}? Masukkan alasan (opsional):`,"Pejabat berhalangan (Sakit/Cuti)");if(l!==null)try{const n=await N.suratApprovals.bypass(t,l);n.success?(f.success("Tahap persetujuan berhasil dilompati"),Y(),ee(null)):f.error(n.message||"Gagal melewati tahap persetujuan")}catch(n){console.error("Error bypassing approval:",n),f.error("Terjadi kesalahan koneksi")}};d.useEffect(()=>{const t=r=>{const l=r.target;te.current&&!te.current.contains(l)&&ee(null)};return document.addEventListener("mousedown",t),()=>document.removeEventListener("mousedown",t)},[]);const[Gt,Vt]=d.useState([]),[Wt,Kt]=d.useState([]),[Xe,qt]=d.useState([]),q=d.useRef(null),[ne,je]=d.useState(null),[ae,ke]=d.useState(null),[_e,et]=d.useState(""),[Yt,tt]=d.useState(!1),Jt=t=>{var l;const r=(l=t.target.files)==null?void 0:l[0];!r||!ne||(ke(r),et(r.name.split(".").slice(0,-1).join(".")))},Qt=async()=>{if(!ae||!ne||!_e.trim())return;const t=O.find(n=>n.id===ne),r=Xe.length>0?Xe[0].id:1,l=(t==null?void 0:t.jenis_surat_id)||r;try{tt(!0);const n=new FormData;n.append("file",ae);const i=ae.name.split(".").pop(),j=`${_e}.${i}`;n.append("nama_file",j),n.append("jenis_dokumen_id",String(l));const c=await N.dokumen.upload(n);if(c.success){const $=c.data.id;await N.suratApprovals.uploadFinal(ne,$),f.success("Dokumen final berhasil diunggah!"),ke(null),je(null),Y()}else f.error(c.message||"Gagal mengunggah dokumen")}catch{f.error("Gagal mengunggah dokumen final")}finally{tt(!1),q.current&&(q.current.value="")}};d.useEffect(()=>{Y(),Zt()},[h,A,D]);const Y=async()=>{try{He(!0);const t={};A!=="all"&&(t.instansi_id=A),D!=="all"&&(t.bidang_id=D);const r=await N.surat.getAll(t);r.success&&wt(r.data)}catch(t){console.error("Failed to fetch surat:",t)}finally{He(!1)}},Zt=async()=>{try{const[t,r,l,n]=await Promise.all([N.bidangInstansi.getAll(),N.instansiDaerah.getAll(),N.jenisDokumen.getAll(),N.masterDataConfig.getDataByTable("master_dokumen")]);if(t.success){let i=t.data;(a==null?void 0:a.tipe_user_id)===1?A!=="all"&&(i=i.filter(c=>c.instansi_id===A)):i=i.filter(c=>c.instansi_id===(a==null?void 0:a.instansi_id)),Vt(i)}if(r.success&&Kt(r.data),l.success&&n.success){const i=l.data.find(j=>j.nama==="Surat");if(i){const j=n.data.filter(c=>c.jenis_dokumen_id===i.id);qt(j)}}}catch(t){console.error("Failed to fetch master data:",t)}},Ne=(t,r)=>{Nt(t),St(r||null),xe(!0),P(null)},Xt=async t=>{const r=O.find(i=>i.id===t),l=(r==null?void 0:r.approval_status)==="APPROVED",n=l?'PERHATIAN: Surat ini sudah FINAL dan memiliki QR Code verifikasi. Menghapus surat ini akan membubuhkan status "DIBATALKAN" secara permanen pada sistem verifikasi. Apakah Anda yakin ingin membatalkan dokumen resmi ini?':"Apakah Anda yakin ingin menghapus catatan surat ini?";if(window.confirm(n))try{const i=await N.surat.delete(t);i.success?(f.success(l?"Dokumen resmi telah dibatalkan.":"Surat berhasil dihapus."),Y()):f.error("Gagal menghapus: "+i.message)}catch(i){console.error("Delete error:",i)}},[v,ea]=d.useState(null);d.useEffect(()=>{(async()=>{const r=await N.suratTemplate.getGlobal();r.success&&ea(r.data)})()},[]);const ta=async t=>{var V;let r=null;if(t.jenis_surat_id){const k=await N.suratTemplate.getById(t.jenis_surat_id);k.success&&(r=k.data)}const l=!!(r!=null&&r.use_global_settings),n=l&&v?v:r||t,i=n.font_size??12,j=n.line_height??1.5,c=n.text_align??"justify",$=(r==null?void 0:r.paragraph_spacing_before)||(l?v==null?void 0:v.paragraph_spacing_before:0)||0,U=(r==null?void 0:r.paragraph_spacing_after)||(l?v==null?void 0:v.paragraph_spacing_after:0)||0,le=(r==null?void 0:r.first_line_indent)||(l?v==null?void 0:v.first_line_indent:0)||0;if(Lt({marginTop:n.margin_top??20,marginBottom:n.margin_bottom??20,marginLeft:n.margin_left??30,marginRight:n.margin_right??20,paperSize:n.paper_size??"A4",fontSize:i,lineHeight:j,textAlign:c,fontFamily:n.font_family||l&&(v==null?void 0:v.font_family)||"Arial, sans-serif",paragraphSpacingBefore:$,paragraphSpacingAfter:U,firstLineIndent:le}),t.file_path)Et(t.file_path),Ye(t.nama_file),Ke(!0);else if(t.isi_surat){let k=t.isi_surat;try{const C=await N.internalInstansi.get(a.instansi_id),J=(t.perihal||"").toLowerCase().includes("cuti")||(t.jenis_surat_nama||"").toLowerCase().includes("cuti")||(r==null?void 0:r.has_detail_cuti);let w={};const oe=r?r.is_kop_surat_required:!0,de=J||(r==null?void 0:r.logo_path)==="none";C.success&&C.data&&C.data.instansiDetail&&(w=C.data.instansiDetail);let se="";if(oe&&w.nama_instansi_kop){if(de)se=`
                    ...
                    `,De=`${String(window.location.origin)}?v=${t.verification_slug||""}`,ze=typeof(w==null?void 0:w.logo_kop_path)=="string"?w.logo_kop_path:"",Ee=t.verification_slug?De:"PREVIEW_ONLY",Ce=`
                        <div style="position: absolute; bottom: 5mm; left: 5mm; z-index: 50;">
                            <div style="padding: 4px; background: white; border: 1px solid #f1f5f9; border-radius: 4px; box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.05); display: flex; align-items: center; justify-content: center;">
                                <img src="${g(Ee,ze)}" style="width: 60px; height: 60px; display: block;" />
                            </div>
                        </div>
                    `;k=`
                        ${se}
