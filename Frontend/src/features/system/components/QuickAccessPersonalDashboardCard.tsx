...
import { ArrowRight, UserCheck, Star, ChevronLeft, ChevronRight, Info } from 'lucide-react';
          ...
          <div className="flex items-center justify-between pt-3 mt-2 border-t border-slate-100/80">
            ...
            <div className="flex items-center gap-1">
              <button
                ...
                className="p-1 rounded-md text-slate-500 hover:text-ppm-slate-light hover:bg-ppm-slate-light/10 disabled:opacity-30 disabled:cursor-not-allowed transition-colors"
