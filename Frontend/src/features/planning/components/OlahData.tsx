...
const OlahData = () => {
  ...
  // Processing modes: 'geografis' or 'manual'
  const [mode, setMode] = useState<'geografis' | 'manual'>('geografis');
          ...
          <div className="p-3 sm:p-6">
            ...
            <div className="grid grid-cols-12 gap-4 sm:gap-6 mt-4">
              ...
              <div className="col-span-12 lg:col-span-9 flex flex-col space-y-4">
                ...
                {mode === 'manual' && customGroupCols.length > 0 && (
                ...
                <div className="flex flex-col space-y-2">
                  <div className="flex items-center justify-between">
                    <label className="block text-[10px] font-extrabold text-slate-500 uppercase tracking-wider">
                      Langkah 3: Pilih Baris Header & Preview Data
                    </label>
            ...
            <div className="mt-4 pt-4 border-t border-slate-100 flex gap-4">
              <button
                ...
                disabled={loading || (mode === 'geografis' ? !hasMinMapping : customGroupCols.length === 0)}
              ...
              >
                {loading ? (
                  ...
                  <>
                    ...
                    <span>Proses & Unduh Rekap Excel</span>
                  </>
                )}
              </button>
            </div>
