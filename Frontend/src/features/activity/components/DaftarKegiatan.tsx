...
interface ActivityDoc {
    ...
    nama_file: string;
    path: string;
    tipe_dokumen: 'surat_undangan_masuk' | 'surat_undangan_keluar' | 'surat_perintah' | 'bahan_desk' | 'paparan' | 'notulensi' | 'foto' | 'laporan';
...
export default function DaftarKegiatan() {
    ...
    const [hoveredDoc, setHoveredDoc] = useState<{ x: number, y: number, cat: any, docs: ActivityDoc[], kegiatanId?: number } | null>(null);
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const allDocFields = ['surat_undangan_masuk', 'surat_undangan_keluar', 'surat_perintah', 'bahan_desk', 'paparan', 'notulensi', 'laporan'];
                                            ...
                                            if (doc.is_trash) {
                                                alert("File ini berada di tempat sampah dan tidak dapat dibuka.");
                                                 ...
                                                 setViewedDoc({ 
                                                     ...
                                                     kegiatan_id: hoveredDoc.kegiatanId,
