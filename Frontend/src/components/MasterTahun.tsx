...
const MasterTahun = () => {
  ...
  const columns = [
    {
      header: getLabel('master_tahun', 'nama', 'Nama Tahun'),
      key: 'nama',
  ...
  return (
    <BaseDataTable<TahunItem>
      title="Master Data Tahun"
      subtitle="Kelola periode tahun anggaran atau pendataan."
      data={data}
      columns={columns}
      loading={loading}
      error={error}
      searchPlaceholder="Cari tahun..."
      addButtonLabel="Tambah Tahun"
      ...
      renderAddRow={() => isAdding && (
        <tr className="bg-blue-50">
          ...
          <td className="p-2 border-b border-slate-100">
            <input autoFocus type="text" className="input-modern" placeholder="Masukkan tahun..." value={newNama} onChange={e => setNewNama(e.target.value)} onKeyPress={e => e.key === 'Enter' && handleAdd()} />
          </td>
          <td className="p-2 border-b border-slate-100">
