...
export const COMMON_ICONS = [
    'LayoutDashboard', 'Users', 'User', 'UserCircle', 'Settings', 'FileText', 'Folder',
...
export default function IconPicker({ value, onChange }: IconPickerProps) {
    ...
    return (
        <div className="relative" ref={wrapperRef}>
            <button
                type="button"
                className="w-full border border-slate-300 p-1.5 text-xs bg-white flex items-center justify-between outline-none focus:border-ppm-slate"
                    ...
                    <div className="p-1.5 border-b border-slate-100 sticky top-0 bg-slate-50">
                        <div className="relative">
                            ...
                            <input
                                autoFocus
                                type="text"
                                className="w-full pl-6 pr-2 py-1 text-[10px] border border-slate-200 outline-none focus:border-ppm-slate rounded-sm"
